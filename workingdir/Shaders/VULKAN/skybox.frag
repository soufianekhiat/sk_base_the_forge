...
#line 11 "C:/git/The-Forge/Examples_3/Unit_Tests/src/01_Transformations/Shaders/FSL/ShaderList.fsl"
#line 1 "C:/git/The-Forge/Examples_3/Unit_Tests/src/01_Transformations/Shaders/FSL/skybox.frag.fsl"
#line 27 "C:/git/The-Forge/Examples_3/Unit_Tests/src/01_Transformations/Shaders/FSL/skybox.frag.fsl"
...
#line 28 "C:/git/The-Forge/Examples_3/Unit_Tests/src/01_Transformations/Shaders/FSL/skybox.frag.fsl"
...
layout(location = 0) in(float4) In_TexCoord;
#line 34
...
//    INIT_MAIN;
	...
	if(side == 1)
    {
        ...
        Out = SampleTex2D(Get(RightText), Get(uSampler0), newtextcoord);
    }
    else if (side == 2)
    {
        newtextcoord = (In.TexCoord.zy) / 20.0 + 0.5;
        newtextcoord = float2(newtextcoord.x, 1.0 - newtextcoord.y);
        Out = SampleTex2D(Get(LeftText), Get(uSampler0), newtextcoord);
    }
    else if (side == 4)
    {
        newtextcoord = (In.TexCoord.xz) / 20.0 + 0.5;
        newtextcoord = float2(newtextcoord.x, 1.0 - newtextcoord.y);
        Out = SampleTex2D(Get(BotText), Get(uSampler0), newtextcoord);
    }
    else if (side == 5)
    {
        newtextcoord = (In.TexCoord.xy) / 20.0 + 0.5;
        newtextcoord = float2(newtextcoord.x, 1.0 - newtextcoord.y);
        Out = SampleTex2D(Get(FrontText), Get(uSampler0), newtextcoord);
    }
    else if (side == 6)
    {
        newtextcoord = (In.TexCoord.xy) / 20.0 + 0.5;
        newtextcoord = float2(1.0 - newtextcoord.x, 1.0 - newtextcoord.y);
        Out = SampleTex2D(Get(BackText), Get(uSampler0), newtextcoord);
    }
	else
    {
        newtextcoord = (In.TexCoord.xz) / 20.0 + 0.5;
        newtextcoord = float2(newtextcoord.x, newtextcoord.y);
        Out = SampleTex2D(Get(TopText), Get(uSampler0), newtextcoord);
    }
    {
    	out_float4 = Out;
    	return;
...
#line 12 "C:/git/The-Forge/Examples_3/Unit_Tests/src/01_Transformations/Shaders/FSL/ShaderList.fsl"
