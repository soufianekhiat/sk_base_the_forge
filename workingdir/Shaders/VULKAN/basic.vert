...
#line 1 "C:/git/The-Forge/Examples_3/Unit_Tests/src/01_Transformations/Shaders/FSL/ShaderList.fsl"
#line 5 "C:/git/The-Forge/Examples_3/Unit_Tests/src/01_Transformations/Shaders/FSL/ShaderList.fsl"
#line 1 "C:/git/The-Forge/Common_3/Tools/ForgeShadingLanguage/includes/fsl_ext.h"
#line 31 "C:/git/The-Forge/Common_3/Tools/ForgeShadingLanguage/includes/fsl_ext.h"
#line 1 "C:/git/The-Forge/Common_3/Tools/ForgeShadingLanguage/includes/vulkan_ext.h"
#line 32 "C:/git/The-Forge/Common_3/Tools/ForgeShadingLanguage/includes/fsl_ext.h"
#line 6 "C:/git/The-Forge/Examples_3/Unit_Tests/src/01_Transformations/Shaders/FSL/ShaderList.fsl"
#line 7 "C:/git/The-Forge/Examples_3/Unit_Tests/src/01_Transformations/Shaders/FSL/ShaderList.fsl"
#line 1 "C:/git/The-Forge/Examples_3/Unit_Tests/src/01_Transformations/Shaders/FSL/basic.vert.fsl"
#line 25 "C:/git/The-Forge/Examples_3/Unit_Tests/src/01_Transformations/Shaders/FSL/basic.vert.fsl"
#line 1 "C:/git/The-Forge/Examples_3/Unit_Tests/src/01_Transformations/Shaders/FSL/resources.h.fsl"
#line 29 "C:/git/The-Forge/Examples_3/Unit_Tests/src/01_Transformations/Shaders/FSL/resources.h.fsl"
#define _GetRightText RightText
#line 29
RES(Tex2D(float4), RightText, UPDATE_FREQ_NONE, t1, binding = 1);
#define _GetLeftText LeftText
#line 30
RES(Tex2D(float4), LeftText, UPDATE_FREQ_NONE, t2, binding = 2);
#define _GetTopText TopText
#line 31
RES(Tex2D(float4), TopText, UPDATE_FREQ_NONE, t3, binding = 3);
#define _GetBotText BotText
#line 32
RES(Tex2D(float4), BotText, UPDATE_FREQ_NONE, t4, binding = 4);
#define _GetFrontText FrontText
#line 33
RES(Tex2D(float4), FrontText, UPDATE_FREQ_NONE, t5, binding = 5);
#define _GetBackText BackText
#line 34
...
#line 50
    DATA(float4x4, toWorld[ 20 ], None);
#define _Getcolor color
#line 51
    DATA(float4, color[ 20 ], None);
#define _Getgeometry_weight geometry_weight
#line 52
    DATA(float4, geometry_weight[ 20 ], None);


#define _GetlightPosition lightPosition
#line 55
    DATA(float3, lightPosition, None);
#define _GetlightColor lightColor
#line 56
    DATA(float3, lightColor, None);

};
#line 26 "C:/git/The-Forge/Examples_3/Unit_Tests/src/01_Transformations/Shaders/FSL/basic.vert.fsl"
...
layout(location = 2) in(float3) TEXCOORD1;
layout(location = 3) in(float3) TEXCOORD3;
layout(location = 4) in(float4) TEXCOORD0;
layout(location = 5) in(float4) TEXCOORD2;
#line 36
...
{
	VSInput In;
	In.Position1 = POSITION;
	POSITION;
	In.Normal1 = NORMAL;
	NORMAL;
	In.Position2 = TEXCOORD1;
	TEXCOORD1;
	In.Normal2 = TEXCOORD3;
	TEXCOORD3;
	In.Color1 = TEXCOORD0;
	TEXCOORD0;
	In.Color2 = TEXCOORD2;
...
//    INIT_MAIN;
    ...
    float InWeight = Get(geometry_weight)[InstanceID].x;
    ...
    float4 normal = normalize(mul(Get(toWorld)[InstanceID], float4(InNormal, 0.0f)));
    float4 pos = mul(Get(toWorld)[InstanceID], float4(InPosition, 1.0f));
    ...
    if (Get(color)[InstanceID].w < 0.01)
    ...
    float3 baseColor = (Get(color)[InstanceID].xyz + InColor) / 2.0;
...
#line 8 "C:/git/The-Forge/Examples_3/Unit_Tests/src/01_Transformations/Shaders/FSL/ShaderList.fsl"
#line 14 "C:/git/The-Forge/Examples_3/Unit_Tests/src/01_Transformations/Shaders/FSL/ShaderList.fsl"
#line 1 "C:/git/The-Forge/Common_3/Tools/ForgeShadingLanguage/includes/fsl_ext.h"
#line 15 "C:/git/The-Forge/Examples_3/Unit_Tests/src/01_Transformations/Shaders/FSL/ShaderList.fsl"
